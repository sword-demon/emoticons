...
export declare function queryParamsToString(
  params: Record<string, undefined | null | string | string[]>
): string;
export declare function getSignHeaders(
  originHeaders: SignParams["headers"],
  needSignHeaders?: string[]
): [string, string];
export declare function uriEscape(str: string): string;
export declare function getDateTimeNow(): string;
export declare function getBodySha(
